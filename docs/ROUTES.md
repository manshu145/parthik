...
**Scope reminder:** all _routes_ work in both languages. Translation **content** is bounded for V1 per [`ARCHITECTURE.md` §12.6](./ARCHITECTURE.md#126-localisation-en-hi) — customer-facing UI and category names are fully Hindi; product text and CMS pages fall back to English until translated.
...
| **D-19a** | Policy _values_ change what the cancel action offers on `/orders/[id]`                                 |
