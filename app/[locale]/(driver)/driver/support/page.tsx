...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <div className="mx-auto flex max-w-2xl flex-col gap-4" data-testid="driver-support">
      <div>
        <h1 className="text-xl font-semibold">{t('support')}</h1>
        <p className="text-muted-foreground mt-1 text-sm">
          {locale === 'hi'
            ? 'आपके सपोर्ट अनुरोध और उनकी वर्तमान स्थिति।'
        ...
        <Card>
          <CardContent className="p-4 text-sm">
            ...
            <p className="text-muted-foreground mt-1">
              {locale === 'hi'
                ? 'नया टिकट बनाने का सुरक्षित write-flow अलग से जोड़ा जाएगा।'
                : 'A secure ticket-creation flow will be added separately.'}
            </p>
          </CardContent>
        </Card>
      ) : (
