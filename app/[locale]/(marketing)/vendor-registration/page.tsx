...
/**
 * `/vendor-registration` (docs/ROUTES.md §3).
 *
...
export async function generateMetadata({
  ...
  return marketingMetadata('vendor-registration', locale);
}

export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  const { locale } = await params;
  return <MarketingPage slug="vendor-registration" localeParam={locale} />;
}
